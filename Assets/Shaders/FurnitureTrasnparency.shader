...
Shader "FurnitureTrasnparency"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_DiffuseMap1("Diffuse", 2D) = "white" {}
		_BaseColor1("BaseColor", Color) = (0,0,0,1)
		_NormalMap1("Normal", 2D) = "white" {}
		_MetallicSmoothnessMap1("MetallicSmoothness", 2D) = "white" {}
		_SmoothnessStrength1("SmoothnessStrength", Range( 0 , 1)) = 0.5
		_AOMap1("AmbientOcclusion", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _DiffuseMap1_ST;
			float4 _BaseColor1;
			float4 _NormalMap1_ST;
			float4 _MetallicSmoothnessMap1_ST;
			float4 _AOMap1_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _DiffuseMap1;
			sampler2D _NormalMap1;
			sampler2D _MetallicSmoothnessMap1;
			sampler2D _AOMap1;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_DiffuseMap1 = IN.ase_texcoord7.xy * _DiffuseMap1_ST.xy + _DiffuseMap1_ST.zw;
				float4 tex2DNode7 = tex2D( _DiffuseMap1, uv_DiffuseMap1 );
				
				float2 uv_NormalMap1 = IN.ase_texcoord7.xy * _NormalMap1_ST.xy + _NormalMap1_ST.zw;
				
				float2 uv_MetallicSmoothnessMap1 = IN.ase_texcoord7.xy * _MetallicSmoothnessMap1_ST.xy + _MetallicSmoothnessMap1_ST.zw;
				float4 tex2DNode8 = tex2D( _MetallicSmoothnessMap1, uv_MetallicSmoothnessMap1 );
				float4 appendResult10 = (float4(tex2DNode8.r , tex2DNode8.g , tex2DNode8.b , 0.0));
				
				float2 uv_AOMap1 = IN.ase_texcoord7.xy * _AOMap1_ST.xy + _AOMap1_ST.zw;
				
				float3 Albedo = ( tex2DNode7 + _BaseColor1 ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _NormalMap1, uv_NormalMap1 ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = appendResult10.x;
				float Smoothness = ( tex2DNode8.a * _SmoothnessStrength1 );
				float Occlusion = tex2D( _AOMap1, uv_AOMap1 ).r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_DiffuseMap1 = IN.ase_texcoord2.xy * _DiffuseMap1_ST.xy + _DiffuseMap1_ST.zw;
				float4 tex2DNode7 = tex2D( _DiffuseMap1, uv_DiffuseMap1 );
...
/*ASEBEGIN
Version=18908
0;0;1920;1019;1596.966;765.1779;1.517782;True;True
Node;AmplifyShaderEditor.SamplerNode;7;-880.2393,-477.173;Inherit;True;Property;_DiffuseMap1;Diffuse;0;0;Create;False;0;0;0;False;0;False;-1;None;5064a29114db2d04794e303350a2918a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;6;-865.2393,-249.1731;Float;False;Property;_BaseColor1;BaseColor;1;0;Create;True;0;0;0;False;0;False;0,0,0,1;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;8;-924.2393,269.827;Inherit;True;Property;_MetallicSmoothnessMap1;MetallicSmoothness;3;0;Create;False;0;0;0;False;0;False;-1;None;dbef15a3352527a4080dc21d13cb3e85;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-463.1009,483.4111;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-443.2393,-371.1731;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-352.3849,231.2469;Inherit;False;Property;_Alpha;Alpha;6;0;Create;True;0;0;0;False;0;False;0.8;0.8;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-514.8741,624.3696;Inherit;True;Property;_AOMap1;AmbientOcclusion;5;0;Create;False;0;0;0;False;0;False;-1;None;2ebc10dfbad15f04e9f58b7a732d636a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-820.6009,586.1105;Inherit;False;Property;_SmoothnessStrength1;SmoothnessStrength;4;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;10;-495.2344,139.5873;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;17;-1218.239,-70.47305;Inherit;True;Property;_NormalMap1;Normal;2;0;Create;False;0;0;0;False;0;False;-1;None;0e22cf31e0ce295409489505fa09017c;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CA4AA49D998C7603DFC437FE175B6E309FFEC9B7